...
/**
 * Ask ForgetPassword if he wants to start with a new repository
 * @returns {Promise<boolean>}
 */
...
/**
 * Checks if we are under Git version control.
 * If we are and this a clone of our repository the ForgetPassword is given a choice to
...
/**
 * ReportContainer the the given error and exits the setup
 * @param {string} error
 */
